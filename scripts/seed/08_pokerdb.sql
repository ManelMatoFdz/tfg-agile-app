...
INSERT INTO poker_sessions (id, project_id, name, status, deck, created_by, current_task_id, timer_seconds, created_at, updated_at) VALUES
                                                                                                                                        ...
                                                                                                                                        ('cccccccc-0001-0000-0000-000000000002','55555555-0000-0000-0000-000000000001','Estimacion red de proveedores','VOTING','FIBONACCI','11111111-0000-0000-0000-000000000005','be43fbdd-1840-4ae7-a834-28f77ac78733',90,now() - interval '6 days',now() - interval '1 days'),
                                                                                                                                        ...
                                                                                                                                        ('cccccccc-0002-0000-0000-000000000002','55555555-0000-0000-0000-000000000002','Estimacion trazabilidad operativa','REVEALED','FIBONACCI','11111111-0000-0000-0000-000000000002','f6820514-2613-422f-8542-b5dbf14f676c',60,now() - interval '9 days',now() - interval '2 days'),
...
('cccc1000-0001-0000-0000-000000000001','cccccccc-0001-0000-0000-000000000001','b1a62c76-e506-4d6a-88f1-6856e653381e','Sala de valoracion con peritos conectados','CONSENSUS',8, now() - interval '13 days',now() - interval '13 days',NULL),
('cccc1000-0001-0000-0000-000000000002','cccccccc-0001-0000-0000-000000000001','e944e69e-b22e-4aa3-97d0-0bcb1edf18e6','Valoracion de danos en tiempo real','CONSENSUS',13,now() - interval '13 days',now() - interval '13 days',NULL),
('cccc1000-0001-0000-0000-000000000003','cccccccc-0001-0000-0000-000000000001','5204dc17-3d4f-4437-ba29-2a68510fdf3f','Comparativa de valoraciones y dispersion','CONSENSUS',8, now() - interval '13 days',now() - interval '13 days',NULL),
('cccc1000-0001-0000-0000-000000000004','cccccccc-0001-0000-0000-000000000001','62270cf0-349c-4f90-80a8-018dfaa10202','Registrar valoracion consensuada en el expediente','CONSENSUS',5,now() - interval '13 days',now() - interval '13 days',NULL),
-- Estimacion red de proveedores: una cerrada y una en curso
('cccc1000-0002-0000-0000-000000000001','cccccccc-0001-0000-0000-000000000002','b8a87beb-dd29-4e8e-aa01-04a2e526869e','Pantalla de actividad de talleres y peritos','CONSENSUS',8,now() - interval '6 days',now() - interval '6 days',NULL),
('cccc1000-0002-0000-0000-000000000002','cccccccc-0001-0000-0000-000000000002','d30ed862-f953-465e-b093-4a35b5df50de','Vincular eventos de proveedores al expediente','CONSENSUS',8,now() - interval '5 days',now() - interval '5 days',NULL),
('cccc1000-0002-0000-0000-000000000003','cccccccc-0001-0000-0000-000000000002','be43fbdd-1840-4ae7-a834-28f77ac78733','Integracion con red de talleres mediante webhooks','VOTING',NULL,now() - interval '1 days',NULL,now() - interval '1 days' + interval '90 seconds'),
-- Estimacion pedidos y stock
('cccc1000-0004-0000-0000-000000000001','cccccccc-0002-0000-0000-000000000001','147bfe10-18b2-4644-b664-e3f012fda7df','Alta y consulta unificada de pedidos','CONSENSUS',8,now() - interval '30 days',now() - interval '30 days',NULL),
('cccc1000-0004-0000-0000-000000000002','cccccccc-0002-0000-0000-000000000001','89a8d44f-d2b5-4f4f-8953-b5bb7d641fbe','Paginacion de pedidos y catalogo','CONSENSUS',4,now() - interval '30 days',now() - interval '30 days',NULL),
('cccc1000-0004-0000-0000-000000000003','cccccccc-0002-0000-0000-000000000001','c133211b-7341-4dfe-816a-f8247a1c5591','Proteccion ante exceso de peticiones de partners','CONSENSUS',4,now() - interval '29 days',now() - interval '29 days',NULL),
-- Estimacion trazabilidad operativa (revelada, pendiente de aceptar)
('cccc1000-0005-0000-0000-000000000001','cccccccc-0002-0000-0000-000000000002','141a0edf-febc-4c6c-9dff-1100b8e43814','Metricas de sincronizacion omnicanal','CONSENSUS',5,now() - interval '9 days',now() - interval '9 days',NULL),
('cccc1000-0005-0000-0000-000000000002','cccccccc-0002-0000-0000-000000000002','f6820514-2613-422f-8542-b5dbf14f676c','Trazabilidad de pedido entre sistemas','REVEALED',NULL,now() - interval '2 days',now() - interval '2 days',NULL),
-- Canal D2C
('cccc1000-0007-0000-0000-000000000001','cccccccc-0006-0000-0000-000000000001','5b68a0db-1f7e-4b3e-bf5f-4a38860716e0','Catalogo y propuesta de valor del canal','CONSENSUS',NULL,now() - interval '12 days',now() - interval '12 days',NULL),
('cccc1000-0007-0000-0000-000000000002','cccccccc-0006-0000-0000-000000000001','d835ec18-fc06-456a-afcd-d5d9e3458c06','Centro de contenidos y recetas','CONSENSUS',NULL,now() - interval '12 days',now() - interval '12 days',NULL);
